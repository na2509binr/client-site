...
export default function AboutPage() {
    return (
        <div>
                ...
                <div className="absolute h-full top-0 grid grid-cols-[1fr_2fr_3fr] items-center text-white">
                    <div className="col-start-2">
                        <h1 className="text-[60px] font-extrabold">
                            <span className="block text-[40px] font-extralight">GIỚI THIỆU</span>
            ...
            <div className="px-2 lg:block xl:px-0 xl:grid xl:grid-cols-[1fr_8fr_1fr] 2xl:grid-cols-[1fr_4fr_1fr] py-12">
                <div className="col-start-2 text-center">
                    <div>
                        <h1 className="text-[40px] font-thin text-center">
                            ĐỘI NGŨ
                            <span className="font-black pl-2">TRONG MƠ</span>
                        </h1>
                        <p className="text-[18px] text-[#b3b3b3] my-6.25 px-60">
