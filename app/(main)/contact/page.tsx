...
//                         <h1 className="text-[40px] lg:text-[60px] font-extrabold text-center">
...
//             <div className="px-4 lg:block xl:px-0 xl:grid xl:grid-cols-[1fr_8fr_1fr] 2xl:grid-cols-[1fr_4fr_1fr] py-16">
//                 <div className="col-start-2 grid grid-cols-1 lg:grid-cols-3 gap-8 items-stretch">
//                     {/* <NewsList data={news} /> */}
...
//                         <div>
//                             <h2 className="text-[28px] lg:text-[32px] text-[#181818] font-bold">Liên hệ:</h2>
//                             <p className="text-[18px] lg:text-[22px] text-[#4e4e4e]">{configSite?.email}</p>
//                         </div>
...
//                         <div>
//                             <h2 className="text-[28px] lg:text-[32px] text-[#181818] font-bold">Gọi cho chúng tôi:</h2>
//                             <p className="text-[18px] lg:text-[22px] text-[#4e4e4e] tabular-nums">{configSite?.hotline}</p>
//                         </div>
//                         <Link href="/" className="self-end">
...
//                         <div>
//                             <h2 className="text-[28px] lg:text-[32px] text-[#181818] font-bold">Vị trí chúng tôi:</h2>
//                             <p className="text-[18px] lg:text-[22px] text-[#4e4e4e] tabular-nums">{configSite?.place}</p>
//                         </div>
//                         <Link href="/" className="self-end">
//                             <div className="py-4 rounded-2xl text-center font-bold bg-[#8b9271] text-white group-hover:text-[#664141] group-hover:bg-[#ff281c] transition-all duration-300 ease-in-out">
//                                 <span>Gửi Email</span>
...
//                 <div className="col-start-2 lg:grid grid-cols-2 gap-x-8 mt-25">
//                     <div className="flex flex-col items-start justify-center">
//                         <h2 className="text-[35px] lg:text-[48px] font-bold">Hãy bắt đầu hợp tác cùng nhau. Liên hệ với chúng tôi.</h2>
...
//                             <Input1 label="Nhập Tên" />
//                             <Input1 label="Nhập Email" />
//                             <Input1 label="Số điện thoại" />
//                             <Textarea1 label="Nội dung" rows={2} />
//                         </div>
...
const InfoIcon = () => (
    <svg
        ...
        xmlns="http://www.w3.org/2000/svg"
    >
        <circle cx="12" cy="12" r="10" fill="#006838" />
        <text
            x="12"
            y="16"
            textAnchor="middle"
...
const defaultContactData: ContactInfo = {
    headquarters: {
        title: "Trụ sở chính",
        address: "Tổ 11, Khóm Bình Đức 5, Phường Bình Đức, Tỉnh An Giang, Việt Nam",
    },
    representative: {
        title: "Văn phòng đại diện",
        address:
            "Lầu 9, Toà nhà Royal Centre Tower A, 235 Nguyễn Văn Cừ, Phường Cầu Ông Lãnh, TP.Hồ Chí Minh, Việt Nam",
    },
    contact: {
        title: "Thông tin liên hệ",
        phone: "(+84) 28 38 333 168",
        email: "info-vwrc@vinhphat.net",
    },
    mapEmbedUrl:
        "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3925.8876543219876!2d105.43217841533516!3d10.383838692599876!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x310a730a4c4b4b4b%3A0x4b4b4b4b4b4b4b4b!2zQ8OUTkcgVFkgVE5ISCBHQcOgIFZJTkggUEjDgVQgV0lMTUFS!5e0!3m2!1svi!2s!4v1699999999999!5m2!1svi!2s",
};
...
const ContactSectionEnhanced: React.FC<ContactSectionProps> = ({
    ...
    return (
        <>
            ...
            <section className="w-full bg-[#f5f0e6] py-10 md:py-16 px-4 md:px-8 lg:px-16">
                <div className="max-w-6xl mx-auto">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-start">
                        {/* Left side - Google Map with orange border */}
                        <div className="w-full">
                            <div className="relative h-80 md:h-[380px] rounded-md overflow-hidden shadow-lg border-[3px] border-[#e6a54a]">
                                <StaticMap height="374px" />
                            </div>
                        </div>

                        {/* Right side - Contact Information */}
                        <div className="flex flex-col space-y-6 md:space-y-8 lg:pl-4">
                            {/* Title */}
                            <h2
                                className="text-4xl md:text-[42px] font-bold text-[#006838] mb-10"
                            ...
                            <div className="flex items-start gap-4">
                                ...
                                <div>
                                    <h3 className="text-base md:text-[17px] font-bold text-gray-800 mb-2">
                                        {data.contact.title}
                                    </h3>
