            ...
            <div className="px-4 lg:block xl:px-0 xl:grid xl:grid-cols-[1fr_8fr_1fr] 2xl:grid-cols-[1fr_4fr_1fr] py-16">
                <div className="col-start-2 grid grid-cols-1 lg:grid-cols-3 gap-8 items-stretch">
                    ...
                    <div className="p-10 rounded-2xl space-y-6 bg-[#f5f3f0] border border-[#f5f3f0] hover:bg-white hover:border-[#ff281c] transition-all duration-300 ease-in-out group h-full grid grid-rows-[auto_auto_1fr] gap-3">
                        ...
                        <div>
                            <h2 className="text-[28px] lg:text-[32px] text-[#181818] font-bold">Mail Us:</h2>
                            <p className="text-[18px] lg:text-[22px] text-[#4e4e4e]">example@gmail.com</p>
                        </div>
                    ...
                    <div className="p-10 rounded-2xl space-y-6 bg-[#f5f3f0] border border-[#f5f3f0] hover:bg-white hover:border-[#ff281c] transition-all duration-300 ease-in-out group h-full grid grid-rows-[auto_auto_1fr] gap-3">
                        ...
                        <div>
                            <h2 className="text-[28px] lg:text-[32px] text-[#181818] font-bold">Call Us:</h2>
                            <p className="text-[18px] lg:text-[22px] text-[#4e4e4e] tabular-nums">0333666073</p>
                        </div>
                        <Link href="/" className="self-end">
                    ...
                    <div className="p-10 rounded-2xl space-y-6 bg-[#f5f3f0] border border-[#f5f3f0] hover:bg-white hover:border-[#ff281c] transition-all duration-300 ease-in-out group h-full grid grid-rows-[auto_auto_1fr] gap-3">
                        ...
                        <div>
                            <h2 className="text-[28px] lg:text-[32px] text-[#181818] font-bold">Visit Us:</h2>
                            <p className="text-[18px] lg:text-[22px] text-[#4e4e4e] tabular-nums">Số 39A phố Pháo Đài Láng, TT Phụ nữ TW, Phường Láng , Thành phố Hà Nội, Việt Nam</p>
                        </div>
                        <Link href="/" className="self-end">
                            <div className="py-4 rounded-2xl text-center font-bold bg-[#8b9271] text-white group-hover:text-[#664141] group-hover:bg-[#ff281c] transition-all duration-300 ease-in-out">
                                <span>Send an Email</span>
                ...
                <div className="col-start-2 lg:grid grid-cols-2 gap-x-8 mt-25">
                    <div className="flex flex-col items-start justify-center">
                        <h2 className="text-[35px] lg:text-[48px] font-bold">Let’s Start Working Together. Get in Touch</h2>
