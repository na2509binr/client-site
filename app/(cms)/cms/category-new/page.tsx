...
import InsertUpdateCategoryForm from "./insert-update-category-new";
import TableCategory from "./table-category-new";
...
export default function CategoryPage() {
  ...
  const handleDelete = async (id: number) => {
    await fetch(`${process.env.NEXT_PUBLIC_API_URL}/api/category-product/delete?id=${id}`, { method: "DELETE" });
    fetchCategories();
  };
